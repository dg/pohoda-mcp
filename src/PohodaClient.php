...
class PohodaClient
{
	...
	private const AgendaNamespaces = [
		'stock' => [
			'listPrefix' => 'lStk',
			'listXsd' => 'list_stock.xsd',
			'listRequest' => 'listStockRequest',
			'requestTag' => 'requestStock',
		],
		'invoice' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listInvoiceRequest',
			'requestTag' => 'requestInvoice',
		],
		'addressbook' => [
			'listPrefix' => 'lAdb',
			'listXsd' => 'list_addBook.xsd',
			'listRequest' => 'listAddressBookRequest',
			'requestTag' => 'requestAddressBook',
			'versionAttr' => 'addressBookVersion',
		],
		'order' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listOrderRequest',
			'requestTag' => 'requestOrder',
		],
		'voucher' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listVoucherRequest',
			'requestTag' => 'requestVoucher',
		],
		'bank' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listBankRequest',
			'requestTag' => 'requestBank',
		],
		'contract' => [
			'listPrefix' => 'lCon',
			'listXsd' => 'list_contract.xsd',
			'listRequest' => 'listContractRequest',
			'requestTag' => 'requestContract',
		],
		'intDoc' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listIntDocRequest',
			'requestTag' => 'requestIntDoc',
		],
		'offer' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listOfferRequest',
			'requestTag' => 'requestOffer',
		],
		'enquiry' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listEnquiryRequest',
			'requestTag' => 'requestEnquiry',
		],
		'vydejka' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listVydejkaRequest',
			'requestTag' => 'requestVydejka',
		],
		'prijemka' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listPrijemkaRequest',
			'requestTag' => 'requestPrijemka',
		],
		'prodejka' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listProdejkaRequest',
			'requestTag' => 'requestProdejka',
		],
		'prevodka' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listPrevodkaRequest',
			'requestTag' => 'requestPrevodka',
		],
		'vyroba' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listVyrobaRequest',
			'requestTag' => 'requestVyroba',
		],
		'accountancy' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listAccountancyRequest',
			'requestTag' => 'requestAccountancy',
		],
		'store' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listStoreRequest',
			'requestTag' => 'requestStore',
		],
		'bankAccount' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listBankAccountRequest',
			'requestTag' => 'requestBankAccount',
			'versionAttr' => 'bankAccountVersion',
		],
		'cashRegister' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listCashRegisterRequest',
			'requestTag' => 'requestCashRegister',
			'versionAttr' => 'cashRegisterVersion',
		],
		'numericalSeries' => [
			'listPrefix' => 'lst',
			'listXsd' => 'list.xsd',
			'listRequest' => 'listNumericalSeriesRequest',
			'requestTag' => 'requestNumericalSeries',
			'versionAttr' => 'numericalSeriesVersion',
		],
		'centre' => [
			'listPrefix' => 'lCen',
			'listXsd' => 'list_centre.xsd',
			'listRequest' => 'listCentreRequest',
			'requestTag' => 'requestCentre',
		],
		'activity' => [
			'listPrefix' => 'lAcv',
			'listXsd' => 'list_activity.xsd',
			'listRequest' => 'listActivityRequest',
			'requestTag' => 'requestActivity',
		],
	];
	...
	/**
	 * @param array{agenda: string, recordId: int, reportId: int, pdfPath?: string, pdfBase64?: bool, printer?: string, copies?: int} $options
	 */
	public function printRecord(array $options): Response
	{
		...
		if ($pdfBase64 && $pdfPath === '') {
			throw new \InvalidArgumentException('pdfPath is required when using pdfBase64');
		}
