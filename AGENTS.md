...
Je mým vroucím přáním, aby tento soubor provázel každého AI agenta pracujícího s kódem v tomto repozitáři.

Popisuje MCP server pro účetní software Pohoda (mServer XML API).
